...
const products = [
    ...
    },
    {
    ...
    },
     {
        ...
        imagenes_por_color: {
            'Amarillo': 'https://belltec.com.co/16786-large_default/taladro-atornillador-38-dewalt.jpg',
            'Azul': 'https://luegopagocdn.azureedge.net/content-process/products-images/prod/1378/0d4b5ad8-d413-4dee-8207-4989490283be.webp', 
            'Rojo': 'https://images.unsplash.com/photo-1504148455328-c376907d081c?w=400&h=300&fit=crop'
        },
    ...
    },
    {
        ...
        imagenes_por_color: {
            'Blanco': 'https://www.bbva.com/wp-content/uploads/2021/07/pintura-ma%CC%81s-blanca-cambio-climatico-sostenibilidad-reflejo-solar-luz-.jpg',
            'Negro': 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTDs_X7QRMwoVCx1IxecQdZv3lWFVRSgmf7Jw&s', 
            'Gris': 'https://thumbs.dreamstime.com/b/pintar-la-pared-con-pintura-gris-427099348.jpg',
            'Azul': 'https://images.unsplash.com/photo-1562259949-e8e7689d7828?w=400&h=300&fit=crop'
        },
    ...
    },
    {
        ...
        imagen: "https://media.falabella.com/sodimacCO/502791/public",
        
        imagenes_por_color: {
            'Negro': 'https://www.construramacolombia.com/medias/?context=bWFzdGVyfGltYWdlc3wxMTczNDJ8aW1hZ2UvcG5nfGltYWdlcy9oNDEvaDRkLzkyMDcxNjI4MzA4NzgucG5nfDUwZDI4NmE1OGY4N2IxZmFhYzEyZDg2ODdkMWNkOGI1MThmMTcxODVhYmY3NTFmNWU4NGQ2MTY3ZGFjMTk1ODM',
            'Azul': 'https://media.falabella.com/sodimacCO/3003346/public', 
            'Verde': 'https://pinturasbler.com/wp-content/uploads/2024/05/ECO-ESMALTE-BLER-GALON.jpg',
            'Rojo': 'https://media.falabella.com/sodimacCO/01225/public'
        },
        precio_oferta: null,
    ...
    },
    {
        ...
        imagenes_por_color: {
            ...
            'Crema': 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRsEZwAjmKebVZo_jpsbsjca9IGTaQgwxrVIg&s', 
            'Gris': 'https://cdncoval.siesadigital.net/convert?type=webp&file=items/images/20250228092910-INTERIOR-PAREDES-Pintura-Viniltex-Advanced-gris-nube-1569-1-Galon-Pintuco-222320250228092910498.jpg'
        },
        precio_oferta: 38900,
    ...
    },
    {
        ...
        imagenes_por_color: {        
            'Rojo': 'https://cdncoval.siesadigital.net/convert?type=webp&file=items/images/20250304105546-INTERIOR-PAREDES-Acriltex-Blanco-Caneca-5-Galones-Pintuco-1003202503041055468374.jpg',
            'Gris': 'https://www.pintuco.com.co/wp-content/uploads/2020/03/koraza-impermeabilizante-termico-3en1-1GL-COL-2024-web.png'
        },
    ...
    },
    {
        ...
        imagen: "https://media.falabella.com/sodimacCO/689921/public",
        imagenes_por_color: {
            'Rojo': 'https://media.falabella.com/sodimacCO/689921/public',
            'Negro': 'https://electroservimos.co/5035-large_default/cbac12nr-cable-thw-no12-negro-aluminiocobrizado-600v-75-gr-cert-retie-andes-rollo-x-100-mts.jpg',
            'Blanco': 'https://electroservimos.co/5034-large_default/cbac12br-cable-thw-no12-blanco-aluminiocobrizado-600v-75-gr-cert-retie-andes-rollo-x-100-mts.jpg',
            'Verde': 'https://http2.mlstatic.com/D_NQ_NP_656624-MCO92551077172_092025-O.webp'
    ...
    },
    {
        ...
        imagenes_por_color: {        
            'Rojo': 'https://ferreteriacasado.es/20352/tesa-tape-cinta-aislante-roja-20x19-tesaflex-53988.jpg',
            'Azul': 'https://media.falabella.com/sodimacCO/311556_2/w=1160',
            'Verde': 'https://media.falabella.com/sodimacCO/311559_2/w=1160',
            'Amarillo': 'https://media.falabella.com/sodimacCO/311557_2/w=1160'
        },
    ...
    },
    {
        ...
        imagenes_por_color: {
            'Amarillo': 'https://redsuministros.com/wp-content/uploads/2020/01/3M_H-702R.jpg',
            'Naranja': 'https://redsuministros.com/wp-content/uploads/2020/01/3M_H-706R.jpg',
            'Azul': 'https://redsuministros.com/wp-content/uploads/2020/01/3M_H-703R.jpg',
            'Verde': 'https://http2.mlstatic.com/D_NQ_NP_656624-MCO92551077172_092025-O.webp'
    ...
    },
    {
        ...
        imagenes_por_color: {
            'Café': 'https://http2.mlstatic.com/D_Q_NP_2X_663497-MCO88922929674_082025-T.webp'
        },
    ...
    },
    {
        ...
        imagenes_por_color: {        
            ...
            'Rojo Óxido': 'https://www.colonoconstruccion.com/ec-colono/images/catalog/products/6238267.jpg',
            'Gris': 'https://media.falabella.com/sodimacCO/65627/public',
            'Negro': 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQxWLgNwrv1qmYa-2OsmXsLKHuhR-7AMh7U_Q&s'
        },        
        precio_oferta: 19900,
    ...
    },
    {
        ...
        imagenes_por_color: {        
            'Naranja': 'https://http2.mlstatic.com/D_NQ_NP_618020-MCO75662774601_042024-O.webp',
            'Amarillo': 'https://ventasyofertas.com.pe/wp-content/uploads/2024/11/TSP63XL-.jpg'
        },
...
function processProductsWithImages(products) {
    return products.map(product => {
        // Si ya tiene imagenes array, no procesar de nuevo
        if (product.imagenes && Array.isArray(product.imagenes)) {
            return product;
        }

        // Extraer todas las URLs de imagen del producto
        // Busca propiedades que empiecen con 'imagen' o contengan URLs de imagen
        const imagenes = [];
        
        // Si tiene múltiples propiedades 'imagen' (la última sobrescribe las anteriores)
        // Necesitamos reconstruir desde el string original o usar un approach diferente
        
        // APPROACH RECOMENDADO: Modificar los productos en data.js para que usen 'imagenes' array
        // Por ahora, creamos un array con la imagen principal y buscamos variantes
        
        if (product.imagen) {
            imagenes.push(product.imagen);
        }

        // Para productos variables, asignar imágenes a atributos específicos
        if (product.tipo === 'variable' && product.atributos) {
            product.imagenes = assignImagesToVariants(product, imagenes);
        } else {
            product.imagenes = imagenes.length > 0 ? imagenes : [product.imagen];
        }
...
function assignImagesToVariants(product, baseImages) {
    // Mapa de imágenes por atributo (ej: color -> imagen)
    const variantImages = {};
    
    // Si el producto tiene atributos con imágenes asociadas
    if (product.atributos) {
        // Para cada atributo (color, voltaje, etc.)
        Object.keys(product.atributos).forEach(attrName => {
            const values = product.atributos[attrName];
            
            // Crear mapeo de valor -> imagen
            values.forEach((value, index) => {
                const key = `${attrName}:${value.toLowerCase()}`;
                // Asignar imagen del array base o usar imagen principal como fallback
                variantImages[key] = baseImages[index] || product.imagen;
            });
        });
    }

    return {
        default: product.imagen,
        variants: variantImages,
        all: baseImages.length > 0 ? baseImages : [product.imagen]
    };
}
...
function getProductImage(product, selectedVariants = {}) {
    if (!product || !product.imagenes) return product?.imagen || '';

    // Si no hay variantes seleccionadas, usar imagen default
    if (Object.keys(selectedVariants).length === 0) {
        return product.imagenes.default || product.imagen;
    }

    // Buscar imagen específica para la variante seleccionada
    // Priorizar el atributo que tenga imagen asociada (ej: color)
    const priorityAttrs = ['color', 'voltaje', 'potencia', 'diametro', 'acabado', 'calibre'];
    
    for (const attr of priorityAttrs) {
        if (selectedVariants[attr]) {
            const key = `${attr}:${selectedVariants[attr].toLowerCase()}`;
            if (product.imagenes.variants && product.imagenes.variants[key]) {
                return product.imagenes.variants[key];
            }
        }
    }

    // Si no hay match específico, usar primera imagen o default
    return product.imagenes.default || product.imagen;
}
